...
class SqlQueryProvider_1_6 extends SqlQueryProviderBase
{
    public function GetProductsSpecialPricesSql($prod_ids)
    {
        ...
        return 'SELECT 
                    ...
                    psp.`reduction_tax`, IF(psp.`reduction_type` = \'percentage\', 0, 1) as reduction_type, psp.`id_currency`, psp.`id_country`,  
